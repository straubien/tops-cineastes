...
// Fonction mutualisée (utilisée par index.js et submit.js — auparavant dupliquée
// avec de légères variantes). Retourne un chemin d'image ou null.
...
function tcLoadAllCineastes(sbClient, offset, pageSize){
  ...
  return sbClient.from('cineastes').select('nom,fbid,url_facebook,duo,naissance,deces,vivant,pays,pays2,photo_tmdb,courant')
