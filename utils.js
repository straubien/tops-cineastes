...
// Cas générique "duo" pour le fallback local : quand un couple de cinéastes est
// stocké sous la forme "NOM1, Prénom1 & NOM2, Prénom2" et ne correspond à aucun
// des couples codés en dur ci-dessus (donc pas de fichier combiné du type
...
function tcLocalPortraitDuoCandidates(nom){
  ...
  var members=nom.split(' & ');
  if(members.length!==2) return null;
  return [tcLocalPortraitCandidates(members[0].trim()),tcLocalPortraitCandidates(members[1].trim())];
}
