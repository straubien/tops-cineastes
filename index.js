...
var PHOTOS_TMDB={}; // nom cinéaste → profile_path TMDB
...
function renderList(items){
  ...
  items.forEach(function(c){
    ...
    var photoHtml=photoPath?'<img class="c-photo" src="https://image.tmdb.org/t/p/w92'+escapeHtml(photoPath)+'" alt="" loading="lazy">':'<div class="c-photo c-photo-empty"></div>';
...
function openFiche(c){
  ...
  var fichePhotoHtml=fichePhotoPath?'<img class="fiche-photo" src="https://image.tmdb.org/t/p/w185'+escapeHtml(fichePhotoPath)+'" alt="">':'<div class="fiche-photo fiche-photo-empty"></div>';
