...
//  - 'ratio' : uniquement les 10 premiers du top films, triés par ratio films/tops.
...
function renderFilmsRanking(){
  ...
  Object.keys(IMPORTED_COUNTS).forEach(function(name){
    ...
    if(imp.films>0)filmsRanking.push({name:name,films:imp.films,ratio:imp.tops>0?imp.films/imp.tops:0});
  });
  filmsRanking.sort(function(a,b){return b.films-a.films;});
  if(FILMS_RANK_MODE==='ratio'){
    // On ne classe QUE les 10 premiers du top « Films dans les tops »,
    // réordonnés par ratio films/tops décroissant.
    filmsRanking=filmsRanking.slice(0,10).sort(function(a,b){return b.ratio-a.ratio;});
  }
