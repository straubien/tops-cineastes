...
function renderProfilPortrait(name,cin){
  ...
  if(courKeys.length||catKeys.length){
    ...
    html+='<div class="pp-card"><div class="pp-card-head">'+t('pp_courants_categories')+'</div>'
      +(courKeys.length?'<div class="pp-mentions">'+courHtml+'</div>':'')
      +(catKeys.length?'<div class="pp-mentions">'+catHtml+'</div>':'')
      +(courKeys.length?'<div class="pp-note">'+t('pp_courants_note')+'</div>':'')
      +(catKeys.length?'<div class="pp-note">'+t('pp_categories_note')+'</div>':'')
      +'</div>';
  }
