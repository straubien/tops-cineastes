...
//  - 'ratio' : 10 premiers cinéphiles triés par ratio films/tops décroissant.
...
function renderFilmsRanking(){
  ...
  if(FILMS_RANK_MODE==='ratio'){
    filmsRanking.sort(function(a,b){return b.ratio-a.ratio;});
    filmsRanking=filmsRanking.slice(0,10);
  } else {
