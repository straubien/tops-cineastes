...
var TC_TRANSLATIONS = {
  fr: {
    ...
    hommages_banner_close: "Fermer",
    hommages_banner_msg: function(a){ var n=a[0],y=a[1]; return (n>1?(n+" cinéastes nous ont quittés"):"Un cinéaste nous a quitté")+" en "+y+" — voir les hommages ›"; },
  ...
  en: {
    ...
    hommages_play: "Play",
    hommages_pause: "Pause",
    hommages_banner_close: "Close",
    hommages_banner_msg: function(a){ var n=a[0],y=a[1]; return (n>1?(n+" filmmakers passed away"):"A filmmaker passed away")+" in "+y+" — see the tributes ›"; },
