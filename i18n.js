...
var TC_TRANSLATIONS = {
  fr: {
    ...
    actu_courant_valide: function(a){ return a[0] + " a proposé le courant « " + a[2] + " » pour " + a[1] + ", validé."; },
    ...
    pp_courants: "Courants les plus représentés",
    ...
    ranking_top_films_tmdb_titre: "50 films les plus vus",
    ranking_top_films_tmdb_vide: "Aucun film associé à TMDB pour l'instant.",
    citations_in_ranking: "vus dans les tops",
    ...
    prop_photo_tmdb_ph: "ex. /abcXYZ123.jpg",
  ...
  en: {
    ...
    actu_courant_valide: function(a){ return a[0] + " suggested the movement « " + a[2] + " » for " + a[1] + ", approved."; },
    ...
    pp_courants: "Most represented movements",
    ...
    ratio_in_ranking: "films/top",
    ranking_top_films_tmdb_titre: "50 most watched films",
    ranking_top_films_tmdb_vide: "No films linked to TMDB yet.",
    citations_in_ranking: "times in tops",
    // Dynamique
    ...
    prop_photo_tmdb_ph: "e.g. /abcXYZ123.jpg",
