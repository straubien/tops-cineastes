...
var TC_TRANSLATIONS = {
  fr: {
    ...
    pp_cineastes_cites: "cinéastes cités",
    pp_films_total: "films au total",
    pp_films_par_cin: "films / cinéaste",
    pp_periode: "période couverte",
    pp_epoque: "Époque de prédilection",
    pp_epoque_note: function(n){ return "Répartition des " + n + " films datés par décennie de sortie."; },
    pp_cinemas: "Cinémas de prédilection",
    pp_cinemas_note: "D’après les nationalités des cinéastes cités.",
    pp_courants: "Courants & genres",
    pp_courants_note: "Mouvements et genres le plus souvent associés aux cinéastes cités.",
    pp_vivants: "Vivants / disparus",
    ...
    pp_extremes: "Extrêmes",
    pp_film_ancien: "Film le plus ancien",
    pp_film_recent: "Film le plus récent",
  ...
  en: {
    ...
    pp_cineastes_cites: "filmmakers cited",
    pp_films_total: "films in total",
    pp_films_par_cin: "films / filmmaker",
    pp_periode: "period covered",
    pp_epoque: "Favourite era",
    pp_epoque_note: function(n){ return "Breakdown of the " + n + " dated films by release decade."; },
    pp_cinemas: "Favourite cinemas",
    pp_cinemas_note: "Based on the nationalities of the filmmakers cited.",
    pp_courants: "Movements & genres",
    pp_courants_note: "Movements and genres most often associated with the filmmakers cited.",
    pp_vivants: "Living / departed",
    pp_en_activite: "Active",
    pp_disparus: "Departed",
    pp_vivants_note: function(n){ return "Based on the " + n + " filmmakers with a known status."; },
    pp_extremes: "Extremes",
    pp_film_ancien: "Oldest film",
    pp_film_recent: "Most recent film",
