...
var TC_TRANSLATIONS = {
  fr: {
    ...
    actu_photogramme_annonce: function(a){ return a[0] + " organise une session Photogramme " + a[1] + " le " + a[2] + "."; },
    // Photogramme
    pg_page_title: "Photogramme",
    pg_intro: "Devinez le titre du film à partir d'un photogramme, le plus vite possible. Un cinéphile peut organiser une session et y ajouter ses propres photogrammes.",
    pg_chargement: "Chargement…",
    pg_creer_session: "Créer une session",
    pg_connexion_requise_creer: "Connectez-vous pour créer une session Photogramme.",
    pg_connexion_requise_jouer: "Connectez-vous pour participer à cette session.",
    pg_groupe_live: "En cours",
    pg_groupe_scheduled: "Programmées",
    pg_groupe_drafts: "Mes brouillons",
    pg_groupe_closed: "Terminées",
    pg_aucune_session: "Aucune session Photogramme pour le moment.",
    pg_session_num: function(n){ return "Session #" + n; },
    pg_par: function(nom){ return "par " + nom; },
    pg_programmee_pour: function(d){ return "Programmée pour le " + d; },
    pg_demarree_a: function(d){ return "Démarrée le " + d; },
    pg_cloturee_a: function(d){ return "Clôturée le " + d; },
    pg_brouillon_meta: "Brouillon, non publié",
    pg_jouer: "Jouer",
    pg_gerer: "Gérer",
    pg_voir_resultats: "Voir les résultats",
    pg_continuer_edition: "Continuer l'édition",
    pg_retour_liste: "Retour à la liste",
    pg_titre_session: "Titre de la session",
    pg_titre_ph: "Ex. : Photogramme spécial polars",
    pg_photogrammes: "Photogrammes",
    pg_titre_film_ph: "Titre du film (réponse attendue)",
    pg_ajouter_photogramme: "Ajouter un photogramme",
    pg_supprimer: "Supprimer",
    pg_lancement: "Lancement",
    pg_lancer_maintenant: "Lancer maintenant",
    pg_ou: "ou",
    pg_programmer: "Programmer",
    pg_supprimer_session: "Supprimer cette session",
    pg_aller_a_la_gestion: "Aller à la gestion",
    pg_session_introuvable: "Session introuvable.",
    pg_non_autorise: "Vous n'êtes pas autorisé(e) à accéder à cette page.",
    pg_err_titre_film_requis: "Le titre du film est requis.",
    pg_err_image_requise: "Une image est requise.",
    pg_err_format: "Format d'image non supporté (JPEG, PNG ou WebP attendu).",
    pg_err_taille: "L'image dépasse la taille maximale autorisée (5 Mo).",
    pg_err_date_requise: "Veuillez choisir une date.",
    pg_err_date_future: "La date doit être dans le futur.",
    pg_confirm_lancer: "Lancer cette session maintenant ? Elle deviendra visible immédiatement.",
    pg_confirm_supprimer_photogramme: "Supprimer ce photogramme ?",
    pg_confirm_supprimer_session: "Supprimer définitivement cette session ?",
    pg_confirm_cloturer: "Clôturer cette session ? Les participants ne pourront plus répondre.",
    pg_photogramme_num: function(n){ return "Photogramme " + n; },
    pg_reponse_envoyee: "Réponse envoyée",
    pg_reponse_ph: "Votre réponse…",
    pg_valider: "Valider",
    pg_organise_par: function(nom){ return "Organisée par " + nom; },
    pg_indice_ph: "Nouvel indice…",
    pg_reveler_indice: "Révéler un indice",
    pg_aucune_reponse: "Aucune réponse pour le moment.",
    pg_avec_indice: "(avec indice)",
    pg_cloturer_session: "Clôturer la session",
    pg_aucun_resultat: "Aucun résultat pour cette session.",
    pg_bonnes_reponses: function(n){ return n + " bonne(s) réponse(s)"; },
    pg_status_draft: "Brouillon",
    pg_status_scheduled: "Programmée",
    pg_status_live: "En cours",
    pg_status_closed: "Terminée",
  ...
  en: {
    ...
    actu_photogramme_annonce: function(a){ return a[0] + " is hosting a Photogramme session " + a[1] + " on " + a[2] + "."; },
    // Photogramme
    pg_page_title: "Photogramme",
    pg_intro: "Guess the movie title from a still, as fast as you can. Any cinephile can organize a session and add their own stills.",
    pg_chargement: "Loading…",
    pg_creer_session: "Create a session",
    pg_connexion_requise_creer: "Log in to create a Photogramme session.",
    pg_connexion_requise_jouer: "Log in to take part in this session.",
    pg_groupe_live: "Live",
    pg_groupe_scheduled: "Scheduled",
    pg_groupe_drafts: "My drafts",
    pg_groupe_closed: "Closed",
    pg_aucune_session: "No Photogramme session yet.",
    pg_session_num: function(n){ return "Session #" + n; },
    pg_par: function(nom){ return "by " + nom; },
    pg_programmee_pour: function(d){ return "Scheduled for " + d; },
    pg_demarree_a: function(d){ return "Started on " + d; },
    pg_cloturee_a: function(d){ return "Closed on " + d; },
    pg_brouillon_meta: "Draft, not published",
    pg_jouer: "Play",
    pg_gerer: "Manage",
    pg_voir_resultats: "View results",
    pg_continuer_edition: "Continue editing",
    pg_retour_liste: "Back to list",
    pg_titre_session: "Session title",
    pg_titre_ph: "E.g.: Special crime film stills",
    pg_photogrammes: "Stills",
    pg_titre_film_ph: "Movie title (expected answer)",
    pg_ajouter_photogramme: "Add a still",
    pg_supprimer: "Delete",
    pg_lancement: "Launch",
    pg_lancer_maintenant: "Launch now",
    pg_ou: "or",
    pg_programmer: "Schedule",
    pg_supprimer_session: "Delete this session",
    pg_aller_a_la_gestion: "Go to management",
    pg_session_introuvable: "Session not found.",
    pg_non_autorise: "You are not authorized to access this page.",
    pg_err_titre_film_requis: "The movie title is required.",
    pg_err_image_requise: "An image is required.",
    pg_err_format: "Unsupported image format (JPEG, PNG or WebP expected).",
    pg_err_taille: "The image exceeds the maximum allowed size (5 MB).",
    pg_err_date_requise: "Please choose a date.",
    pg_err_date_future: "The date must be in the future.",
    pg_confirm_lancer: "Launch this session now? It will become visible immediately.",
    pg_confirm_supprimer_photogramme: "Delete this still?",
    pg_confirm_supprimer_session: "Permanently delete this session?",
    pg_confirm_cloturer: "Close this session? Participants will no longer be able to answer.",
    pg_photogramme_num: function(n){ return "Still " + n; },
    pg_reponse_envoyee: "Answer sent",
    pg_reponse_ph: "Your answer…",
    pg_valider: "Submit",
    pg_organise_par: function(nom){ return "Hosted by " + nom; },
    pg_indice_ph: "New hint…",
    pg_reveler_indice: "Reveal a hint",
    pg_aucune_reponse: "No answers yet.",
    pg_avec_indice: "(with hint)",
    pg_cloturer_session: "Close session",
    pg_aucun_resultat: "No results for this session.",
    pg_bonnes_reponses: function(n){ return n + " correct answer(s)"; },
    pg_status_draft: "Draft",
    pg_status_scheduled: "Scheduled",
    pg_status_live: "Live",
    pg_status_closed: "Closed",
