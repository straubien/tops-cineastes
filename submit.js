...
function buildAvatarHtml(photoVal){
  ...
  return '<img class="sp-view-avatar" src="https://image.tmdb.org/t/p/w92'+path+'" alt="" loading="lazy">';
}
...
function renderViewList(containerId, items){
  ...
  el.innerHTML = '<div class="sp-view-list">' + items.map(function(n){
    ...
    var avatarHtml = buildAvatarHtml(PHOTOS_TMDB[n] || PHOTOS_TMDB[clean.trim()]);
